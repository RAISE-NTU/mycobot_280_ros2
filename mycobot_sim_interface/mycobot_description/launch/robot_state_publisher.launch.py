...
:author: Original by Addison Sears-Collins, adapted for Humble
:date: February 2026
"""
import os
...
def process_ros2_controllers_config(context):
    ...
    with actual configuration, and writes the processed file.
    ...
    pkg_share_moveit = FindPackageShare('mycobot_moveit_config').find('mycobot_moveit_config')
