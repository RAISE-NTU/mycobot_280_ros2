...
def generate_launch_description():
    ...
    # camera-driven work should run with use_gz_gui:=false.
    ...
    # Robot spawner — wrapped in OpaqueFunction so we can auto-raise z onto the
    # table top when world_file:=calibration.world is selected and the user did
    # not override z explicitly.
